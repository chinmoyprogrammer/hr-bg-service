...
```
cd existing_repo
git remote add origin https://gitlab.com/mbw-erp/hr-admin-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mbw-erp/hr-admin-backend/-/settings/integrations)
