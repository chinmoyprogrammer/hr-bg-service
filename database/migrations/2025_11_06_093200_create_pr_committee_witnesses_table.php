...
return new class extends Migration {
    ...
    {
        Schema::create('pr_committee_witnesses', function (Blueprint $table) {
            $table->bigIncrements('id');

            $table->unsignedBigInteger('pr_committee_id');
            $table->unsignedBigInteger('witness_user_id');
            ...
            $table->index(['witness_user_id']);

            $table->foreign('pr_committee_id')->references('id')->on('pr_committee')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign('witness_user_id')->references('id')->on('users')->onUpdate('cascade')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('pr_committee_witnesses');
    }
};