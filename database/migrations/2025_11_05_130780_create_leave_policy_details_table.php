...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('leave_policy_details', function (Blueprint $table) {
            ...
            $table->enum('encashment', ['Yes','No'])->default('No');
            $table->enum('encashment_rate', ['Basic','Gross'])->nullable();
            $table->tinyInteger('is_compensatory')->default(0);
            $table->integer('eligible_after_days')->default(0);
