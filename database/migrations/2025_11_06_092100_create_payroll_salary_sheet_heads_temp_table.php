...
return new class extends Migration {
    ...
    {
        Schema::create('payroll_salary_sheet_heads_temp', function (Blueprint $table) {
            $table->bigIncrements('id');

            $table->unsignedBigInteger('salary_sheet_temp_id');
            ...
            $table->index(['salary_sheet_temp_id']);
            $table->index(['head_id']);

            $table->foreign('salary_sheet_temp_id')->references('id')->on('payroll_salary_sheet_temp')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('payroll_salary_sheet_heads_temp');
    }
};