...
return new class extends Migration {
    ...
    {
        Schema::create('employee_approval_types', function (Blueprint $table) {
            $table->bigIncrements('id');

            $table->enum('approval_type_name', ['Temp', 'Administrative', 'Financial']);
            ...
            $table->index('approval_type_name');
    ...
    {
        Schema::dropIfExists('employee_approval_types');
    }
};