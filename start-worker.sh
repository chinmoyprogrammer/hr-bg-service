...
TRIGGER_QUEUES="${HR_BG_TRIGGER_QUEUES:-processTempData_trigger_queue,employeeDeactivation_trigger_queue,insertWeekendHolidays_trigger_queue,confirmProvisionalEmployees_trigger_queue,syncRosterAssignments_trigger_queue,fiscalYearClosing_trigger_queue,cacheRegenerate_trigger_queue}"
