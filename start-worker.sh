...
QUEUES="${HR_BG_WORKER_QUEUES:-processTempData_queue,processManualData_queue,insertWeekendHolidays_queue,processTempSalary_queue,processRealSalary_queue,absentAdjustmentWithLeave_queue,sendBulkSMS_queue,sendBulkSMSToMultiUserOneSMS_queue}"
