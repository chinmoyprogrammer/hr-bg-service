...
```
cd existing_repo
git remote add origin https://gitlab.com/mbw-erp/reporting-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mbw-erp/reporting-backend/-/settings/integrations)
